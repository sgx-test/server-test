...
use multi_party_ecdsa::curv::elliptic::curves::secp256_k1::{FE, GE, SK};
...
//mod common;
//use multi_party_ecdsa::gg20::common::{broadcast, poll_for_broadcasts, poll_for_p2p, postb, sendp2p, Params, PartySignup};
//use anyhow::Result;
use common::*;
...
pub fn key_sign(url:&str,keypair: PartyKeyPair, keystore:&str , message:&str) /*-> Result<(SK,SK,FE,FE,u8)> */{
    ...
    let message = &message[..];
    println!("[key_sign ]message is {:?}",message);
