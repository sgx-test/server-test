...
use multi_party_ecdsa::curv::cryptographic_primitives::hashing::hash_sha256::HSha256;
use multi_party_ecdsa::curv::cryptographic_primitives::hashing::traits::Hash;
...
use key_ops::{PartyKeyPair,EnclaveId};
...
fn key_sign(enclave: EnclaveId,message_str:String,) {
    ...
    let res_stage1: SignStage1Result = enclave.sign_stage1_exec(input_stage1);
    ...
    let res_stage2: SignStage2Result = enclave.sign_stage2_exec(input_stage2);
    ...
    let res_stage3: SignStage3Result = enclave.sign_stage3_exec(input_stage3);
    ...
    let res_stage4: SignStage4Result = enclave.sign_stage4_exec(input_stage4);
    ...
    let res_stage5: SignStage5Result = enclave.sign_stage5_exec(input_stage5);
    ...
    let res_stage6: SignStage6Result = enclave.sign_stage6_exec(input_stage6);
    ...
    let res_stage7: SignStage7Result = enclave.sign_stage7_exec(input_stage7);
